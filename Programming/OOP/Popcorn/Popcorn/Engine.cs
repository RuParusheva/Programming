...
namespace Popcorn
{
    public class Engine
    {
        ...
        public uint ThreadSpeed
        {
            get { return this.threadSpeed; }
            set { this.threadSpeed = value; }
        }

        public Engine(IRenderer renderer, IUserInterface userInterface, uint threadSpeed)
        {
        ...
        public virtual void Run()
        {
            while (true)
            {
                ...
                System.Threading.Thread.Sleep((int)(this.ThreadSpeed));
