/*Task 07. Write a program that finds the largest area of equal neighbor elements in a rectangular matrix
 and prints its size. Example:
           {1, 3, 2, 2, 2, 4},
           {3, 3, 3, 2, 4, 4},
           {4, 3, 1, 2, 3, 3}, -> 13
           {4, 3, 1, 3, 3, 1},
...
class DepthFirstSearch
{
    ...
    static void Main()
    {
        ...
        Console.WriteLine("Number of elements is: {0}", maxCount);
    }
}
